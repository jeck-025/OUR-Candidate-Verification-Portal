  ...
  <main class="flex-shrink-0">
    ...
    <section class="wrapper">
      <div class="container-fluid mt-5 pt-5 slide-in-left rounded shadow show-maintenance text-center" data-aos="fade-down" data-aos-duration="1500">
        ...
        <h1>Submission for Verification Form is Currently Closed.</h1><hr>
        <h3>Form is open during Monday to Saturday, 8:00 a.m. to 5:00 p.m., Philippine Standard Time (GMT+8)</h3>
