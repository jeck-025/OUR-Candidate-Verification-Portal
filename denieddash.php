...
<body class="d-flex flex-column h-100">
   ...
   <aside id="sidebar" class="sidebar">
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <a href="locker.php?landing=denieddash" class="btn btn-sm <?php $locker->lockerButtonClr(); ?>">
        <?php $locker->lockerButton(); ?></a>
        <a href="lockerM.php?landing=denieddash" class="btn btn-sm <?php $locker->lockerMButtonClr(); ?>">
                            ...
                            <div class="card recent-sales overflow-auto">
                                <ul class="nav nav-pills  nav-justified" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <?php
                                            if(isset($_GET['date'])){
                                                echo "<a class='nav-link active' href='denieddash?date=".$_GET['date']."' type='button' role='tab' aria-controls='pills-profile' aria-selected='true'>Denied Verifications <span class='badge active'>";
                                            }else{
                                                echo "<a class='nav-link active' href='denieddash' type='button' role='tab' aria-controls='pills-profile' aria-selected='true'>Denied Verifications <span class='badge active'>";
                                            }
                                ...
                                <div class="card-body">
                                 <?php
                                    if(isset($_GET['date']) && ($_GET['date'] != "")) {
                                       ...
                                       $viewtable->viewDeniedData($year, $month, $viewtype);
                                    }else{
                                       $viewtype = "current";
                                       $viewtable->viewAllDeniedData($viewtype);
                                    }
                                 ?>
