...
<body class="d-flex flex-column h-100">
   ...
   <aside id="sidebar" class="sidebar">
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <a href="locker.php?landing=approveddash-prev-app" class="btn btn-sm <?php $locker->lockerButtonClr(); ?>">
        <?php $locker->lockerButton(); ?></a>
        <a href="lockerM.php?landing=approveddash-prev-app" class="btn btn-sm <?php $locker->lockerMButtonClr(); ?>">
                  ...
                  <div class="col-12">
                     <div class="card recent-sales overflow-auto">
                        ...
                        <ul class="nav nav-pills  nav-justified" id="pills-tab" role="tablist">
                           ...
                           <li class="nav-item">
                                 <?php
                                    echo "<a class='nav-link active' href='approveddash-prev-app.php' type='button' role='tab' aria-controls='pills-home' aria-selected='true'>Approved Verifications <span class='badge active'>";
                        ...
                        <div class="card-body">
                           <?php
                              $viewtable->viewAllApprovedData("legacy");
                           ?>
