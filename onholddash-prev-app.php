                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                <ul class="nav nav-pills  nav-justified" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                          <?php
                                             echo "<a class='nav-link active' href='onholddash-prev-app.php' type='button' role='tab' aria-controls='pills-profile' aria-selected='true'>On-Hold Verifications <span class='badge active'>";
                                ...
                                <div class="card-body">
                                    <?php
                                       $viewtable->viewAllOnHoldData("legacy");
                                    ?>
