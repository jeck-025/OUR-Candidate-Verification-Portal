                  ...
                  <div class="col-12">
                     <div class="card recent-sales overflow-auto">
                        ...
                        <ul class="nav nav-pills  nav-justified" id="pills-tab" role="tablist">
                           ...
                           <li class="nav-item">
                              <a class="nav-link active" href="approveddash" type="button" role="tab" aria-controls="pills-profile" aria-selected="true">Approved Application <span class="badge active">
                                    <?php
                                    if (isset($_GET['date'])  && ($_GET['date'] != "")) {
                                       $strArray = explode("-", $_GET['date']);
                                       $year = $strArray[0];
