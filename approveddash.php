         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="card">
                     <div class="card-body report">
                        <h3 class="report-title pt-4 main-part mb-4">Breakdown of Verification Remarks</h3>
                        <?php
                           if(isset($_GET['date']) && ($_GET['date'] != "")) {
                                 $strArray = explode("-", $_GET['date']);
                                 $year = $strArray[0];
                  ...
                  <div class="card">
                     <div class="card-body report">
                        <form action="" method="GET">
                           <h3 class="report-title main-part pt-4 mb-3">View Other Monthly Report</h3>
                           ...
                           <br><a class="btn btn-info date_btn mt-2" href="approveddash">Clear</a>
                        </form>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                           ...
                           if (isset($_GET['date'])  && ($_GET['date'] != "")) {
                              ...
                              $year = $strArray[0];
                              $month = $strArray[1];
                              $viewtable->viewApprovedData($year, $month);
                           } else {
                              $viewtable->viewAllApprovedData();
                           }
                           ?>
