...
<body class="d-flex flex-column h-100">
   ...
   <aside id="sidebar" class="sidebar">
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <a href="locker.php?landing=onholddash" class="btn btn-sm <?php $locker->lockerButtonClr(); ?>">
        <?php $locker->lockerButton(); ?></a>
        <a href="lockerM.php?landing=onholddash" class="btn btn-sm <?php $locker->lockerMButtonClr(); ?>">
